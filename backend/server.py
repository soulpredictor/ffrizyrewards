        ...
        def _loop():
            ...
            while True:
                ...
                try:
                    ...
                    app.logger.exception("LUXDROP snapshot capture failed")
...
if __name__ == "__main__":
    ...
    print(f"LUXDROP stats: http://127.0.0.1:{port}/api/luxdrop/stats?start_date=...&end_date=...")
